...
def parse_args():
    ...
    parser.add_argument("--model", default="yolov5n.yaml", help="YOLOv8 model weights or yaml, e.g. yolov8n.yaml")
    ...
    parser.add_argument("--name", default="yolov5n", help="Experiment name")
