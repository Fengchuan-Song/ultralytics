...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--weights", 
        default='/data/yolov11/weights/yolov11_best.pt', 
    ...
    parser.add_argument("--output", default="/data/yolov11/predict_results", help="Directory used to save txt prediction files")
