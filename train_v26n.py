...
def parse_args():
    ...
    parser.add_argument("--model", default="yolo26n.yaml", help="YOLOv8 model weights or yaml, e.g. yolov8n.yaml")
    ...
    parser.add_argument("--name", default="yolov26n", help="Experiment name")
